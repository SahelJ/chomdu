...
<div class="container_cv">
    <section class="colonne_gauche" id="colonne_gauche">
        <div class="photo_profil" >
            <img class="photo_profil" src="<?php echo get_template_directory_uri().'/asset/img/fond_chemise.jpg'; ?>" alt="photo-profil">
        </div>
        <div class="wrap_cgcv">
            <div class="titre_cv">
...
<?php the_post_navigation(
				array(
					'prev_text' => '<span class="nav-subtitle">' . esc_html__( 'Previous:', 'chomdu' ) . '</span> <span class="nav-title">%title</span>',
					'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next:', 'chomdu' ) . '</span> <span class="nav-title">%title</span>',
				)
			); ?>
<div class="header-nuage3">
