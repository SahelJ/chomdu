    ...
    <section class="descriptif wrap">
        <div class="descriptif-text">
            <div class="descriptif-title">
                <h2>select the rigth condidate</h2>
                <h4>over 5,500 client worlwide</h4>
        ...
        <div class="descriptif-info">
            <h2>social media <span>. featured services</span></h2>
            <h4>discover the good ...</h4>
        ...
        <div class="shape"><img src="assets/img/fond_chemise.jpg" alt=""></div>
    </section>
