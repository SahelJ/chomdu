    ...
    <footer>
        <div class="article wrap">
            <div class="article-link">
                <h5 class="h5-anim">Nos partenaires</h5>
                <a href="">lorem ipsum</a>
                <a href="">lorem ipsum</a>
                <a href="">lorem ipsum</a>
            </div>
            <div class="article-link">
                <h5 class="h5-anim">Nos autres projets</h5>
                <a href="">lorem ipsum</a>
                <a href="">lorem ipsum</a>
                <a href="">lorem ipsum</a>
            </div>
            <div class="article-link">
                <h5 class="h5-anim">Ils nous font confiance</h5>
                <a href="">lorem ipsum</a>
                <a href="">lorem ipsum</a>
                <a href="">lorem ipsum</a>
            </div>
            <div class="article-link">
                ...
                <a href="<?php echo esc_url(home_url('home')) ?>">Acceuil</a>
                <a href="<?php echo esc_url(home_url('about')) ?>">Qui sommes-nous</a>
                <a href="">Nous contacter</a>
            </div>
        </div>
        <div class="article-foo">
            <div class="article-foo-link">
                <p>www.ChomDu.fr - Tous droits réservé 2021</p>
                <a href="<?php echo esc_url(home_url('mentions-legal')) ?>">mentions légales</a>
            </div>
